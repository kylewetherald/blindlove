...
/**
 * Model representing authorization roles such as Client, Accountant
 */
@Entity
public class SecurityRole extends Model implements Role {
    ...
    public static void initializeSecurityRoles() {
        if (SecurityRole.find.findRowCount() == 0) {
            for (final String roleName : Arrays.asList(models.User.USER_ROLE, User.ACCOUNTANT_ROLE, User.CLIENT_ROLE)) {
